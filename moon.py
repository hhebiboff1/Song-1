...
def help(client, message):
    ...
    message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
                    InlineKeyboardButton('💌 ʙᴇɴɪ ɢʀᴜʙᴀ ᴇᴋʟᴇ 💌', url=f'http://t.me/+M1F9txSqfR01OTdi'),
                  ],[
                    InlineKeyboardButton('📚 ᴋᴀɴᴀʟ', url=f'https://t.me/lovestory2505')
                  ],[
                    InlineKeyboardButton('👤 ᴏᴡɴᴇʀ', url=f'https://t.me/hhebiboff')
                  ]
            ]
        )
    )
